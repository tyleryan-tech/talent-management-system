...
(function () {
  ...
  describe('Cross-Module Data Sync', function (it, beforeEach) {
    ...
    it('department rename should sync recruitmentPipeline', function () {
    ...
    it('removing position should nullify employee positionId', function () {
    ...
    it('talent matrix should sync after HRBP calibration', function () {
    ...
    it('_reviewsByEmp index should be accurate', function () {
      if (data.performanceReviews.length === 0) return;
    ...
    it('_empMap should provide O(1) lookup', function () {
